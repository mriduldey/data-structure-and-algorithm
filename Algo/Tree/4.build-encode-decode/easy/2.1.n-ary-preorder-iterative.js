...
function preorderIterative(root) {
  ...
  while (stack.length) {
    ...
    for (let i = children.length - 1; i >= 0; i--) {
      children[i] && stack.push(children[i]);
    }
  }
...
const tree5 = new Node(100, [
  new Node(20, [new Node(200, [new Node(500)]), new Node(300)]),
  new Node(30, [new Node(400)]),
]);
...
console.log("Tree 1 Preorder:", preorderIterative(tree1));
// Expected: [1, 2, 5, 6, 3, 4]

console.log("Tree 2 preorderIterative:", preorderIterative(tree2));
// Expected: [1, 2, 3, 4]

console.log("Tree 3 preorderIterative:", preorderIterative(tree3));
// Expected: [10, 1, 2, 3, 4, 5]

console.log("Tree 4 preorderIterative:", preorderIterative(tree4));
// Expected: [42]

console.log("Tree 5 preorderIterative:", preorderIterative(tree5));
