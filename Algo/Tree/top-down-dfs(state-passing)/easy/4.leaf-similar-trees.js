...
function similarLeafTrees(root1, root2) {
  ...
  console.log("1: ", leaves1)
  console.log("2: ", leaves2)
...
console.log('Example 1:', similarLeafTrees(example1, example2)); // false
console.log('Example 2:', similarLeafTrees(example3, example4)); // true
console.log('Example 3:', similarLeafTrees(example5, example6)); // false
console.log('Example 4:', similarLeafTrees(example1, example3)); // false
