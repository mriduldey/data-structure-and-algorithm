...
function validateBstInorderIterative(root) {
  let prev = -Infinity;
  let curr = root;
  const stack = [];
...
console.log(
  ...
  validateBstInorderIterative(validTree),
);

console.log(
  "Test 2 (Immediate Violation): Expected false ->",
  validateBstInorderIterative(invalidImmediate),
);

console.log(
  "Test 3 (Deep Violation): Expected false ->",
  validateBstInorderIterative(invalidDeep),
);

console.log(
  "Test 4 (Empty Tree / Null): Expected true ->",
  validateBstInorderIterative(null),
);
