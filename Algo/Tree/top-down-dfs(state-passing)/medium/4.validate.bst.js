...
const invalidImmediate = new TreeNode(
  10,
  new TreeNode(12),
  new TreeNode(15)
);
...
console.log("Test 1 (Valid Tree): Expected true ->", validateBST(validTree));

console.log("Test 2 (Immediate Violation): Expected false ->", validateBST(invalidImmediate));

console.log("Test 3 (Deep Violation): Expected false ->", validateBST(invalidDeep));

console.log("Test 4 (Empty Tree / Null): Expected true ->", validateBST(null));