...
function validateBSTIterative(root) {
  if (!root) return true;
...
console.log("Test 1 (Valid Tree): Expected true ->", validateBSTIterative(validTree));

console.log(
  "Test 2 (Immediate Violation): Expected false ->",
  validateBSTIterative(invalidImmediate),
);

console.log(
  "Test 3 (Deep Violation): Expected false ->",
  validateBSTIterative(invalidDeep),
);

console.log("Test 4 (Empty Tree / Null): Expected true ->", validateBSTIterative(null));
