...
function insertBSTiterative(root, val) {
...
// Input Tree: null
// Value to insert: 10
console.log(insertBSTiterative(null, 10));
...
console.log(insertBSTiterative(tree2, 12));
...
console.log(insertBSTiterative(tree3, 8));
...
// Value to insert: 8
console.log(insertBSTiterative(tree4, 8));
...
console.log(insertBSTiterative(tree5, 35));
